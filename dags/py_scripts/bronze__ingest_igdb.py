...
def main(endpoint):
    ...
    # game types 3 = bundles, 5 = mods, 12 = forks, unnecessary
    games_query = """
    fields 
        name, 
        id, 
    ...
    paired = {
        endpoint: games_query if endpoint == 'games' else base_body_query
    }
    batch_size = 500
    all_results = []
    offset = 0
    ...
    while True:
        body_query = paired[endpoint].format(batch_size=batch_size, offset=offset, last_updated=last_updated)
